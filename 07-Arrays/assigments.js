...
const calcAverageHumanAge = function (ages) {
  ...
  const adultsDogs = humanAge.filter((age) => age >= 18);
  console.log(adultsDogs);

  const humanAgeAverage =
    adultsDogs.reduce((acc, age) => acc + age, 0) / adultsDogs.length;
  console.log(humanAgeAverage);

  // 2 3. (2+3)/2 = 2.5 === 2/2+3/2 = 2.5
  const average = adultsDogs.reduce(
...
// adults.length doesn't exist, therefore to achieve the length of the array, you have to use this method: 2 3. (2+3)/2 = 2.5 === 2/2+3/2 = 2.5
