...
// freeze() method block the object being mutating
const spendingLimits = Object.freeze({
  alan: 1500,
  jessica: 100,
});
// spendingLimits.alex = 200;

// const limit = spendingLimits[user] ? spendingLimits[user] : 0;
const getLimit = (limits, user) => limits?.[user] ?? 0;

// Pure function :D
const addExpense = function (state, limits, value, description, user = "alan") {
...
const newBudget3 = addExpense(newBudget2, spendingLimits, 200, "Stuff", "Alex");
